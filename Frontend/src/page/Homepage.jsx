...
<div class="bg-black pb-6 sm:pb-8 lg:pb-12">
  <div class=" max-w-screen-3xl bg-black">
    <header class="mb-4 flex items-center justify-between py-4 md:py-8 bg-black  w-full">
      ...
      <a href="/dashboard" class="hidden rounded-lg bg-black px-8 py-3 text-center text-sm font-semibold text-green-300 outline-none ring-indigo-300 transition duration-100 hover:outline-green-200 focus-visible:ring active:text-gray-700 md:text-base lg:inline-block">Get Started</a>
                ...
                <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                    <div className="justify-between sm:flex">
                        ...
                        <img class="w-10" src="./public/piller-r.png" alt="logo" />
                            ...
                            AI-Driven Research Engine offers tailored legal insights and predictive analytics for efficient, multilingual, and transparent commercial dispute resolution
                            </p>
                        </div>
                        <div className="mt-6">
